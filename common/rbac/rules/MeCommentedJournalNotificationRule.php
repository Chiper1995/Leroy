...
class MeCommentedJournalNotificationRule extends Rule
{
    ...
    public function execute($userId, $item, $params)
    {
        ...
        return
            ...
            and ($paramJournalComment->journal->getComments()->andWhere(['user_id'=>$userId])->count() > 0) // я уже комментировал эту запись
            ;
    }
}