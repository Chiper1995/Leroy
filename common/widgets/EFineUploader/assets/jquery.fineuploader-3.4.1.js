...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        text: {
            ...
            dragZone: 'Переместите файлы для загрузки сюда',
            dropProcessing: 'Подготовка к загрузке...',
        ...
        messages: {
            tooManyFilesError: "Вы можете загружать только один файд"
        },
        retry: {
            showAutoRetryNote: true,
            autoRetryNote: "Попытка {retryNum}/{maxAuto}...",
            showButton: false
        },
        deleteFile: {
            forceConfirm: false,
            ...
            deletingFailedText: "Ошибка при удалении"
