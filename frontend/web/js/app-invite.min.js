...
*/
                               title: 'Настоящим я даю свое согласие ООО «ЛЕРУА МЕРЛЕН ВОСТОК» (ИНН: 5029069967, ОГРН: 1035005516105, место нахождения: 141031, Московская обл., г. Мытищи, Осташковское шоссе, 1, тел. +7 (495) 961-01-60) и третьим лицам, осуществляющим обработку моих персональных данных по поручению ООО «ЛЕРУА МЕРЛЕН ВОСТОК», на обработку моих персональных данных  в связи с моим участием в проекте «Семьи Леруа Мерлен» («Проект»): фамилия, имя, номер телефона, адрес электронной почты, адрес проведения ремонтных работ, пользовательские данные (MAC-адрес, тип и версия ОС, тип и версия браузера, тип устройства и разрешение его экрана и т.д.), данные о проводимых ремонтных/строительных работах, включая суммы, потраченные на приобретение тех или иных товаров для ремонта, фотографии, размещенные мной на Платформе, в том числе, содержащие мое изображение и/или изображение помещения, в котором проводятся ремонтные работы, а также любую другую информацию, сообщенную мной в ходе участия в Проекте Организатору, сведения об адресе аккаунта в социальных сетях, в том числе на их сбор, запись, систематизацию, накопление, хранение, уточнение (обновление, изменение), извлечение, использование, передачу (предоставление, доступ), блокирование, удаление, уничтожение, совершаемых с использованием средств автоматизации или без использования таких средств.'+
                                       'Я проинформирован, что обработка моих персональных данных осуществляется в целях моего участия в Проекте, проведения интервью, сопровождения потребителей товаров в процессе ремонта, продажи товаров и оказания услуг, предоставления мне справочной информации, получения обратной связи в отношении товаров/услуг, улучшения качества обслуживания покупателей, изучения и анализа рынка, изучения потребностей покупателей, проведения маркетинговых и иных исследований, связи со мной по вопросам участия в Проекте, а также в целях обеспечения соблюдения законов, иных нормативных правовых актов РФ. Я соглашаюсь на трансграничную передачу моих персональных данных на территорию стран, ратифицировавших «Конвенцию о защите физических лиц при автоматизированной обработке персональных данных» от 28.01.1981г.'+
                                       'Настоящее согласие дано мною лично и добровольно. Настоящее согласие действует в течение 20 лет и может быть отозвано мной в письменной форме в любой момент путем направления уведомления ООО «ЛЕРУА МЕРЛЕН ВОСТОК» по адресу: 115162, г. Москва, ул. Шаболовка, д. 31, стр. А, в ООО «ЛЕРУА МЕРЛЕН ВОСТОК». Более полная информация о политике ООО «ЛЕРУА МЕРЛЕН ВОСТОК» в отношении обработки персональных данных приведена здесь .»'+ 
                                       '«Я согласен получать информационные сообщения по средствам электронной почты, WhatsApp, Telegram, Viber, Skype и других коммуникационных сервисов или по телефону».',
                                required: true,
				multi: true,
				answers: [
					'Согласен'
    ...
    computed: {
        visibleQuestions: function () {
           ...
           // console.log(vm.questions[questionIndex].counter+=1);
            return result;
        }
    },
    created: function () {
    ...
    methods: {
		start: function() {
			this.started = true;
                ...
                agreedRulesCheck: function() {
                   if (this.agreedRules == true){ 
                   this.agreedRules = false;
                   } else this.agreedRules = true;
                },
