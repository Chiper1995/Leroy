function AllJournalsGoods(elementId, treeViewElementId, modalElementId, formElementId, searchModel) {
    var $this = this;
    if(searchModel===undefined)
        searchModel = 'AllJournalSearch';
    ...
    this.addRow = function(id, name) {
        ...
        p.append('<li data-id="'+id+'"><span class="goods-delete">&times;</span>'+name+'<input type="hidden" value="'+id+'" name="'+searchModel+'[goods_filter][]"></li>');
        $this.visiblePrompt();
    };
