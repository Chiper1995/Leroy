...
/* @var \common\models\notifications\VisitOnAgreementNotification $notification */

?>

<li class="notification VisitOnAgreementNotification">
    <div class="icons">
        <p class="icon" style="">
            <?=Html::icon('time')?>
        </p>
    ...
    <div class="content">
        <div>
            ...
            <p style="padding-bottom: 4px"><?= Html::a('Подробнее &rarr;', ['notification/show', 'id'=>$notification->id, 'url'=>\yii\helpers\Url::to(['visit/agreement', 'id' => $notification->visit->id, 'returnUrl'=>Yii::$app->request->url])], ['class' => 'btn btn-primary', 'style' => 'width: 150px;']) ?></p>
        </div>
    </div>
